HexToDec. Java tutorials. Console Application. Simple Input/Output. Strings. Algorithms.
...
HexToDec. Занятия по Java. Консольное приложение. Простой Ввод/вывод. Строки. Алгоритмы.
...
Программа делает следующее:
  ...
  2. Проверяет правильная ли строка была введена.
     Она должна быть короче 8 символов и содержать только цифры от 0 до 9 и буквы от A(a) до F(f).
